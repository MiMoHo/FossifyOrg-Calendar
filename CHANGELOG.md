...
- Fixed tapping a date in the monthly widget opening the current day instead of the selected day when birthdays/anniversaries are imported automatically ([#233])
...
[#233]: https://github.com/FossifyOrg/Calendar/issues/233
