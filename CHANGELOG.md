...
- Fixed long-pressing the only visible event type in the quick filter not restoring all event types ([#1092])
...
[#1092]: https://github.com/FossifyOrg/Calendar/issues/1092
